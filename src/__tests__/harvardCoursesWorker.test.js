...
describe('Harvard catalogue Worker contract', () => {
  ...
  it('tolerates malformed optional upstream fields without failing the catalogue response', () => {
    const result = normalise({
      results: [
        {
          courseID: 'malformed-optional-fields',
          catalogSubject: 'HKS',
          classCatalogNumber: '999',
          publishedInstructors: { instructorName: 'Not an array' },
          meetings: [null, { daysOfWeek: ['M'], startTime: '09:00', location: 101 }],
        },
        null,
      ],
    })
    ...
    expect(result.results).toEqual(
      expect.arrayContaining([
        expect.objectContaining({
          harvardId: 'malformed-optional-fields',
          instructors: [],
          location: '101',
        }),
      ]),
